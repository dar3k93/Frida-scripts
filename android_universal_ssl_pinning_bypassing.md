### Frida universal SSL pinning bypassing multiply methods

*** frida -U -f com.app.name -l frida_multiple_unpinning.js --no-pause***
       ...
       // Trustkit (triple bypass)
        ...
        try {
            ...
            appcelerator_PinningTrustManager.checkServerTrusted.implementation = function () {
                console.log('[+] Bypassing Appcelerator PinningTrust')
                            };
